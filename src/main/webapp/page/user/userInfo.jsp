...
<form id="registerForm" class="layui-form">
    ...
    <button id="J_addsuppliers" data-toggle="modal" data-target="#J_addsuppliersDialog" data-width="large"
            data-backdrop="static" class="sui-btn btn-bordered btn-large btn-info" style="margin-left:650px">修改 </button>
                    ...
                    <div class="modal-body sui-form form-horizontal">
                        ...
                        <table class="sui-table table-bordered-simple">
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="password" id="password_qsc"
                                ...
                                <td><input type="text" name="phonenum" id="address_qc"
