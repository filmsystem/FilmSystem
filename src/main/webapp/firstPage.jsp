  ...
  <script type="text/javascript" src="http://g.alicdn.com/sj/dpl/1.5.1/js/sui.min.js"></script>
    ...
    <div class="sui-navbar navbar-inverse">
      <div class="navbar-inner"><a href="#" class="sui-brand">SHU-MOVIE</a>
        ...
        <ul class="sui-nav pull-right">
          <button data-toggle="modal" data-target="#myModal" data-keyboard="false" class="sui-btn btn-bordered btn-large">登录</button>
              ...
              <div class="modal-content">
                ...
                <form class="sui-form form-horizontal" style="margin-left:48px">
                  <div class="control-group" >
                    ...
                    <div class="controls">
                      <input type="text" id="inputEmail" placeholder="ID" class="input-large">
                    </div>
                  </div>
                  <div class="control-group">
                  ...
                  <label class="radio-pretty inline checked" style="margin-left:88px">
                    <input type="radio" checked="checked" name="radio"><span>用户</span>
                  </label>
                  <label class="radio-pretty inline">
                    <input type="radio" name="radio"><span>影院方</span>
                  </label>
                  <label class="radio-pretty inline">
                    <input type="radio" name="radio"><span>管理员</span>
                  </label>

                  <div class="control-group">
                    <label class="control-label"></label>
                    <div class="modal-footer">
                      <button type="submit" data-ok="modal" class="sui-btn btn-primary btn-large">登录 </button>
                      <button type="submit" data-dismiss="modal" class="sui-btn btn-default btn-large">取消</button>
                    </div>
                  </div>
                </form>
              </div></div></div>
          ...
          <button data-toggle="modal" data-target="#myModal2" data-keyboard="false" class="sui-btn btn-bordered btn-large">注册</button>
              ...
              <div class="modal-content">
                ...
                <form class="sui-form form-horizontal" style="margin-left:48px">
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <input id="autocomplete" type="text" name="country" placeholder="输入..."  autocomplete="off">
    ...
    <div id="myCarousel2" class="sui-carousel slide" align="center" width="800px">
      ...
      <div class="carousel-inner" >
        <div class="active item"><img src="/FilmSystem/img/1.png" width="850" height="120" >
          <div class="carousel-caption">
            
            <p>内容内容内容内容内容内容内容内容内容内容内容内容</p>
          </div>
        </div>
        <div class="item"><img src="/FilmSystem/img/1.png" width="850" height="120">
          <div class="carousel-caption">
    ...
    <table class="sui-table table-nobordered">
      ...
      <tr style="margin-left:30px" height="50">
        <td width="140px"></td>
        <td width="180px"><img src="/FilmSystem/img/2.png" width="160" height="100" align="center"></td>
        <td width="180px"><img src="/FilmSystem/img/2.png" width="160" height="100" align="center"></td>
        <td width="180px"><img src="/FilmSystem/img/2.png" width="160" height="100" align="center"></td>
        <td width="180px"><img src="/FilmSystem/img/2.png" width="160" height="100" align="center"></td>
        <td width="180px"><img src="/FilmSystem/img/2.png" width="160" height="100" align="center"></td>
      ...
      <tr style="margin-left:20px" height="20px">
        <td></td>
        <td><p align="center" class="sui-text-xlarge">反恐风暴</p></td>
        <td><p align="center" class="sui-text-xlarge">反恐风暴</p></td>
        <td><p align="center" class="sui-text-xlarge">反恐风暴</p></td>
        <td><p align="center" class="sui-text-xlarge">反恐风暴</p></td>
        <td><p align="center" class="sui-text-xlarge">反恐风暴</p></td>
